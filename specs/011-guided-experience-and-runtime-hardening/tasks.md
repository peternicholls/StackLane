...
- [ ] T025 [US4] Extend runtime summary with service metadata in /Users/peternicholls/Dev/stageserve/core/guidance/types.go and /Users/peternicholls/Dev/stageserve/cmd/stage/commands/guidance_context.go; expose only normalized service facts needed for user-goal actions, not raw container/runtime dumps.
- [ ] T026 [US4] Implement deterministic service selection rules for logs/restart in /Users/peternicholls/Dev/stageserve/core/guidance/planner.go and /Users/peternicholls/Dev/stageserve/cmd/stage/commands/tui.go; keep ambiguous service detail in a secondary selector or advanced fallback.
- [ ] T027 [US4] Add guided `open_browser` action and launcher handling in /Users/peternicholls/Dev/stageserve/cmd/stage/commands/tui.go; label it as the user goal `Open in browser` and surface unsupported launcher states as calm recovery copy.
- [ ] T028 [US4] Add guided logs viewport flow in /Users/peternicholls/Dev/stageserve/core/guidance/shell.go and /Users/peternicholls/Dev/stageserve/cmd/stage/commands/tui.go; preserve log stream text, add only project identity, stable exit hints, and return-to-screen consistency.
- [ ] T029 [US4] Add guided restart-service action reusing lifecycle/compose seams in /Users/peternicholls/Dev/stageserve/cmd/stage/commands/tui.go and /Users/peternicholls/Dev/stageserve/core/lifecycle/orchestrator.go; require explicit service identity and confirmation copy before mutation.
- [ ] T030 [US4] Add `More…`/advanced-actions fallback surface and reorder actions to non-destructive defaults in /Users/peternicholls/Dev/stageserve/core/guidance/planner.go and /Users/peternicholls/Dev/stageserve/core/guidance/shell.go; keep direct commands, plain-text fallback, hidden paths, and advanced troubleshooting secondary.
- [ ] T031 [P] [US4] Add running-project day-2 behavior tests in /Users/peternicholls/Dev/stageserve/core/guidance/planner_test.go and /Users/peternicholls/Dev/stageserve/cmd/stage/commands/root_guidance_test.go; assert default action is non-destructive, visible defaults precede actions, and implementation vocabulary does not lead the screen.
