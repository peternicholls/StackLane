...
> **Historical artifact — superseded by spec 004.** This document is the sprint-closure handoff that produced spec 004 and intentionally still describes the pre-004 contract (`.stackenv`, `stacklane-<slug>`, legacy `<stackHome>/.env` fallback). For the current contract see [`contracts/workflow-lifecycle-contract.md`](./contracts/workflow-lifecycle-contract.md), [`spec.md`](./spec.md), and [`data-model.md`](./data-model.md). Do not edit this file as part of doc-parity work.
