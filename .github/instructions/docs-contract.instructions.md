---
applyTo: "README.md,docs/**,specs/004-workflow-and-lifecycle/**,.env.stacklane.example"
---
...
- project-local config: `<project>/.env.stacklane`
- stack-wide defaults: `<stack-home>/.env.stacklane`
