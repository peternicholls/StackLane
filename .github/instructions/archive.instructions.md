...
Do not treat archive files as the source of truth for current Stacklane behavior. Use them only when the task explicitly asks for migration history, compatibility analysis, or archival cleanup.
